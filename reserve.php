  ...
  <?php   
	...
	?>
  	...
  	<label>Court: </label><select id="court" name="court" />
            ...
            <option value="o1">Outdoor Court 7</option>
            <option value="o2">Outdoor Court 8</option>
            <option value="o3">Outdoor Court 9</option>
            <option value="o4">Outdoor Court 10</option>
            <option value="o5">Outdoor Court 11</option>
            <option value="o6">Outdoor Court 12</option>
            <option value="o7">Outdoor Court 13</option>
            <option value="o8">Outdoor Court 14</option>
            <option value="o9">Outdoor Court 15</option>
            <option value="o10">Outdoor Court 16</option>
            <option value="o11">Outdoor Court 17</option>
            <option value="o12">Outdoor Court 18</option>
