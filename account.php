  ...
  <div id="acctable">
	<h3>My Reservations</h3>
	  ...
	  <?php
		...
		$ssql = "SELECT res_id, date, start, end, court FROM tennis_reservations WHERE date >= CURDATE() ORDER BY start ASC";
		...
		if (mysqli_num_rows($sresult) > 0) {
			while ($srow = mysqli_fetch_assoc($sresult)) {
				...
				echo "<td>$end</td>";
				echo "<td>$court</td>";
				echo "<td><a href = \"del.php?res_id=$res\" target = \"_blank\">DELETE</a></td>";
				echo "</tr>";
				}
